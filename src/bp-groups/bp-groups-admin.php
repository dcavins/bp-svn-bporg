...
function bp_groups_admin_edit_metabox_settings( $item ) {
	...
	<?php if ( bp_allow_hierarchical_groups() ) : ?>
		<div class="bp-groups-settings-section" id="bp-groups-settings-section-group-hierarchy">
			<fieldset>
				<legend><?php _e( 'Parent Group', 'buddypress' ); ?></legend>
			...
			<fieldset>
				...
				?>
				<ul>
					<li><label for="allowed-subgroup-creators-members"><input type="radio" name="allowed-subgroup-creators" id="allowed-subgroup-creators-members" value="member" <?php checked( $subgroup_creators, 'member' ); ?> /> <?php _e( 'All group members', 'buddypress' ); ?></label></li>

					<li><label for="allowed-subgroup-creators-mods"><input type="radio" name="allowed-subgroup-creators" id="allowed-subgroup-creators-mods" value="mod" <?php checked( $subgroup_creators, 'mod' ); ?> /> <?php _e( 'Group admins and mods only', 'buddypress' ); ?></label></li>

					<li><label for="allowed-subgroup-creators-admins"><input type="radio" name="allowed-subgroup-creators" id="allowed-subgroup-creators-admins" value="admin" <?php checked( $subgroup_creators, 'admin' ); ?> /> <?php _e( 'Group admins only', 'buddypress' ); ?></label></li>

					<li><label for="allowed-subgroup-creators-noone"><input type="radio" name="allowed-subgroup-creators" id="allowed-subgroup-creators-noone" value="noone" <?php checked( $subgroup_creators, 'noone' ); ?> /> <?php _e( 'No one', 'buddypress' ); ?></label></li>
				</ul>
			</fieldset>
		</div>
	<?php endif; ?>
