...
function bp_group_admin_tabs( $group = false ) {
	...
	if ( 'accepts_membership_requests' == bp_groups_group_has_property( $group, 'join_method' ) ) {
...
function bp_group_join_button( $group = false ) {
	...
	function bp_get_group_join_button( $group = false ) {
		...
		// Not a member.
			...
			} elseif ( 'anyone_can_join' == bp_groups_group_has_property( $group, 'join_method' ) ) {
				$button = array(
					'id'                => 'join_group',
					'component'         => 'groups',
					'must_be_logged_in' => true,
			...
			} elseif ( 'accepts_membership_requests' == bp_groups_group_has_property( $group, 'join_method' ) ) {
...
function bp_group_status_message( $group = null ) {
	...
	// Group has a status.
		...
		} elseif ( 'invitation_only' == bp_groups_group_has_property( $group, 'join_method' ) ) {
