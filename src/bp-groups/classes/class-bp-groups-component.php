...
class BP_Groups_Component extends BP_Component {
	...
	public function setup_nav( $main_nav = array(), $sub_nav = array() ) {
		...
		if ( bp_is_groups_component() && bp_is_single_item() ) {
			...
			if ( bp_current_user_can( 'create_subgroups', array( 'group_id' => $this->current_group->id ) ) ||
				 bp_groups_has_children( $this->current_group->id, bp_loggedin_user_id() ) ) {
				$sub_nav[] = array(
					'name'            => _x( 'Member Groups', 'Subgroup directory screen nav', 'buddypress' ),
					'slug'            => 'hierarchy',
					'parent_url'      => $group_link,
					'parent_slug'     => $this->current_group->slug,
